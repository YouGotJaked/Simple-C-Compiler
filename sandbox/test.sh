...
gcc -m32 -g results/mixed.s
./a.out < examples/mixed.in > results/mixed.out
diff results/mixed.out examples/mixed.out

echo ---------tree.c-------------
./scc < examples/tree.c > results/tree.s
gcc -m32 -g results/tree.s
